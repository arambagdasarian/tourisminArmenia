...
let currentView = 'countries'; // 'overview', 'countries', 'flow'
let currentRegionFilter = 'all';
let currentTopCountries = '10';
let countryLayers = {};
...
function switchToDetailView() {
    ...
    document.getElementById('viewSelect').value = 'countries';
    updateMapData();
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    addEventListenerSafely('viewSelect', 'change', handleControlChange);
    ...
    addEventListenerSafely('generateComparison', 'click', generateComparisonChart);
    
    addEventListenerSafely('trendsButton', 'click', function() {
        populateTrendCountries();
        const modal = new bootstrap.Modal(document.getElementById('trendsModal'));
        modal.show();
    });
    
    addEventListenerSafely('generateTrends', 'click', generateTrendsChart);
    ...
    addEventListenerSafely('fullscreenButton', 'click', function() {
        const mapContainer = document.getElementById('mapContainer');
        ...
        if (!isFullscreen) {
            ...
            // Hide other UI elements in fullscreen
            document.body.style.overflow = 'hidden';
        } else {
            // Exit fullscreen
            mapContainer.classList.remove('map-fullscreen');
            if (dashboardControls) dashboardControls.style.display = 'block';
            this.innerHTML = '<i class="bi bi-fullscreen"></i> Fullscreen';
            isFullscreen = false;
